 ...
 */
final class Version20231228204754 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equipment (id INT AUTO_INCREMENT NOT NULL, project_de_recherche_id INT NOT NULL, nom VARCHAR(50) NOT NULL, etat TINYINT(1) NOT NULL, INDEX IDX_D338D583649BD9FF (project_de_recherche_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
